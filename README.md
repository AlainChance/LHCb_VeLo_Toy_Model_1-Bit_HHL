...
## Note on Utility-Scale Quantum Computers
In his solo breakout session at Quantum World Congress, Matthias Troyer from Microsoft pointed out:

> *"Because logical qubits are vastly more complex than classical transistors and operate at slower clock speeds, early quantum systems won’t be general-purpose replacements for CPUs. Instead, they’ll act as accelerators targeted at problems where quantum speedups are truly transformative and input/output (I/O) demands are low."*
> — [*Building Utility Scale Quantum Computers with Microsoft's Matthias Troyer*](https://www.quantumworldcongress.com/news-and-updates/matthias-troyer-on-building-a-utility-scale-quantum-machine)

### Quantum computers operate at much slower clock speeds than classical chips
In his talk *Disentangling Hype from Reality: Achieving Practical Quantum Advantage* (Q2B 2020), Matthias Troyer presented a slide at around 6:50 titled: **"Quantum computers need fewer operations, but each operation is slower by more than ten orders of magnitude."**

### Quantum computers are slow at reading data
He also pointed out that the bandwidth for loading data into a quantum computer is at least 10,000 times slower than loading data onto a classical chip (see the slide at around 5:10 titled **"Quantum computers are slow at reading data"**):
...
*To use a quantum algorithm, classical data must somehow be brought into a quantum circuit. This is usually referred to as data encoding, but it is also called data loading.*
— Qiskit, *Quantum Machine Learning: Data Encoding*, IBM Quantum Platform

Various encoding techniques are discussed in the section *Data Encoding in Quantum Systems* in:

Tripathi, S., Upadhyay, H., & Soni, J. (2026). *A quantum machine learning–based predictive analysis of CERN collision events*. Scientific Reports, 16, 682.
